...
public class ItemList {
    ...
    //유니크아이템
   public static Item 뉴트스캐맨더의가면=new UniqueItem("뉴트 스캐맨더의 가면",80,"유니크",10,20,30,5,20);
    ...
    //스페셜아이템
    public static Item 그리핀도르의검=new SpecialItem("그리핀도르의 검",10,"스페셜",2,2,3,3,2,"그리핀도르", MagicSpellList.크루시오);
